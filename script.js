(() => {
  ...
  const OBJECTS = [
    ...
    {
      id: 'train', name: 'Freight train', short: 'Train', h: 140, halfW: 312, hC: 70, scale: 0.6, shakeK: 0.4,
      fact: 'An empty boxcar weighs about 30,000 kg (66,000 lb), but its huge flat side catches the wind. A locomotive weighs about 190,000 kg (420,000 lb).',
      bits: ['#8a3b2b', '#e8742a', '#cfe8f7', '#333333'],
      motions: ['shake', 'shake', 'shake', 'shake', 'shake', 'shake'],
      sev: [0, 1, 2, 3, 4, 5],
      effects: [
        ['Rolling on', 'A train is very heavy. It keeps going.'],
        ['Swaying', 'Empty boxcars rock on their wheels. Loose loads can blow off.'],
        ['Cars blown over', 'Empty boxcars get blown off their wheels and tipped over.'],
        ['Derailed', 'Wheel sets are torn loose and cars leave the tracks. The heavy locomotive stays on the rails.'],
        ['Cars thrown', 'Rail cars are lifted and thrown off the tracks.'],
        ['Wrecked', 'Even locomotives are knocked off the tracks and crumpled.'],
      ],
      parts: [
        R(-300, -2, 10, 4, '#5a4030'),
        R(-270, -2, 10, 4, '#5a4030'),
        ...
        R(300, -2, 10, 4, '#5a4030'),
        R(0, -5, 624, 4, '#7a7a7a'),
        R(-160, -75, 270, 90, '#8a3b2b', 2, { id: 'box', mass: 3, stroke: 'rgba(0,0,0,.25)' }),
        R(-160, -73, 60, 80, '#7a3325', 99, { on: 'box', stroke: 'rgba(0,0,0,.3)' }),
        R(-160, -27, 270, 6, '#333333', 99, { on: 'box' }),
        R(-252, -16, 44, 8, '#333333', 3, { mass: 1 }),
        R(-68, -16, 44, 8, '#333333', 3, { mass: 1 }),
        Wheel(-264, -10, 10, 3, { mass: 0.6 }),
        Wheel(-240, -10, 10, 3, { mass: 0.6 }),
        Wheel(-80, -10, 10, 3, { mass: 0.6 }),
        Wheel(-56, -10, 10, 3, { mass: 0.6 }),
        R(0, -28, 30, 5, '#333333', 2, { mass: 0.4 }),
        R(155, -28, 290, 8, '#333333', 5, { mass: 2 }),
        R(130, -70, 210, 72, '#e8742a', 5, { id: 'loco', mass: 4, stroke: 'rgba(0,0,0,.2)' }),
        R(130, -52, 210, 6, '#ffffff', 99, { on: 'loco' }),
        R(60, -88, 44, 22, '#555555', 99, { on: 'loco' }),
        R(265, -82, 60, 96, '#e8742a', 5, { id: 'cab2', mass: 2, stroke: 'rgba(0,0,0,.2)' }),
        R(265, -112, 42, 18, '#a9d8f2', 1, { on: 'cab2', hole: '#2b3038', mass: 0.3 }),
        R(80, -110, 10, 8, '#333333', 3, { mass: 0.3 }),
        R(250, -135, 16, 4, '#9aa0a6', 2, { mass: 0.2 }),
        Wheel(45, -10, 10, 5, { mass: 0.8 }),
        Wheel(75, -10, 10, 5, { mass: 0.8 }),
        Wheel(215, -10, 10, 5, { mass: 0.8 }),
        Wheel(245, -10, 10, 5, { mass: 0.8 }),
      ],
    },
    {
      id: 'plane', name: 'Small plane', short: 'Plane', h: 105, halfW: 132, hC: 52,
      fact: 'A small four-seat plane weighs about 750 kg (1,700 lb). Its wings make lift, so even a weak tornado can flip it. Big airliners weigh over 40,000 kg and are much harder to move.',
      bits: ['#f4f4f4', '#c0392b', '#a9d8f2'],
      motions: ['slide', { m: 'lift', h: 60, d: 80 }, { m: 'lift', h: 170, d: 220 }, 'fly', 'fly', 'fly'],
      sev: [1, 3, 4, 5, 5, 5],
      effects: [
        ['Pulling at ropes', 'Wind over the wings makes lift. A tied-down plane strains at its ropes. An untied one gets pushed around.'],
        ['Flipped', 'Small planes get flipped onto their backs. Their own wings help lift them.'],
        ['Thrown', 'Planes are lifted and thrown. Wings and tails snap off.'],
        ['Airborne', 'The plane is carried into the air and wrecked.'],
        ['Shredded', 'Planes are torn apart in the air. Hangars around them are destroyed too.'],
        ['Gone', 'Pieces are scattered for kilometers.'],
      ],
      parts: [
        P([[-120, -60], [-128, -102], [-110, -102], [-88, -64]], '#f4f4f4', 2, { mass: 0.5 }),
        R(-124, -96, 16, 8, '#c0392b', 2, { mass: 0.2 }),
        R(-108, -60, 44, 4, '#dddddd', 2, { mass: 0.4 }),
        R(33, -28, 3, 32, '#777777', 3, { rot: 0.25, mass: 0.3 }),
        R(100, -28, 3, 26, '#777777', 3, { mass: 0.3 }),
        P([[-125, -60], [-120, -66], [-40, -62], [40, -70], [60, -72], [95, -66], [112, -58], [112, -44], [95, -38], [40, -34], [-40, -50], [-120, -56]],
          '#f4f4f4', 99, { id: 'fus' }),
        R(20, -46, 150, 4, '#c0392b', 99, { on: 'fus', rot: -0.08 }),
        P([[40, -68], [60, -70], [82, -64], [82, -54], [40, -52]], '#a9d8f2', 1, { on: 'fus', hole: '#2b3038', mass: 0.3 }),
        R(46, -56, 3, 40, '#999999', 2, { rot: 0.7, mass: 0.3 }),
        R(40, -78, 100, 7, '#f4f4f4', 2, { mass: 0.8, stroke: 'rgba(0,0,0,.12)' }),
        R(117, -51, 4, 40, '#333333', 1, { mass: 0.3 }),
        C(113, -51, 5, '#c0392b', 2, { mass: 0.2 }),
        Wheel(36, -9, 9, 3, { mass: 0.4 }),
        Wheel(100, -8, 8, 3, { mass: 0.4 }),
      ],
    },
    {
      id: 'boat', name: 'Boat on trailer', short: 'Boat', h: 102, halfW: 132, hC: 50,
      fact: 'A small fishing boat on its trailer weighs about 1,000 kg (2,200 lb).',
      bits: ['#f4f4f4', '#1f5f9e', '#a9d8f2'],
      motions: ['shake', { m: 'lift', h: 35, d: 50 }, { m: 'lift', h: 130, d: 170 }, 'fly', 'fly', 'fly'],
      sev: [1, 2, 3, 4, 5, 5],
      effects: [
        ['Cover torn', 'Canvas tops and covers rip off. Loose gear blows away.'],
        ['Flipped', 'Boats and their trailers get flipped over. Boats in the water get swamped.'],
        ['Thrown', 'Boats are lifted and thrown, often onto houses and cars.'],
        ['Airborne', 'Boats are carried through the air and smashed.'],
        ['Piled up', 'Whole marinas are wrecked, with boats piled on top of each other.'],
        ['Gone', 'Boats are shredded and scattered far away.'],
      ],
      parts: [
        R(0, -22, 220, 6, '#555555'),
        R(140, -20, 70, 4, '#555555'),
        R(-20, -30, 34, 5, '#444444', 3, { mass: 0.3 }),
        Wheel(-20, -12, 12, 3, { mass: 0.5 }),
        R(-118, -62, 10, 34, '#333333', 2, { mass: 0.4 }),
        R(-118, -82, 18, 18, '#222222', 2, { mass: 0.4 }),
        P([[-110, -28], [-110, -70], [100, -70], [128, -80], [112, -46], [80, -28]], '#f4f4f4', 99, { id: 'hull' }),
        R(0, -52, 205, 5, '#1f5f9e', 99, { on: 'hull' }),
        R(-20, -76, 22, 12, '#dddddd', 99),
        P([[20, -70], [30, -88], [50, -88], [50, -70]], '#a9d8f2', 1, { hole: '#2b3038', mass: 0.3 }),
        R(-60, -86, 2, 32, '#bbbbbb', 0, { mass: 0.2 }),
        R(0, -86, 2, 32, '#bbbbbb', 0, { mass: 0.2 }),
        R(-30, -102, 74, 5, '#1f5f9e', 0, { mass: 0.3 }),
      ],
    },
    {
    ...
    {
      id: 'bridge', name: 'Highway bridge', short: 'Bridge', h: 215, halfW: 205, hC: 100, scale: 0.9, shakeK: 0.15,
      fact: 'A concrete highway overpass. Never shelter under one in a tornado: the wind speeds up underneath, and nothing stops the flying debris.',
      bits: ['#9a9a92', '#c5c9ce', '#1f7a3c'],
      motions: ['shake', 'shake', 'shake', 'shake', 'shake', 'shake'],
      sev: [0, 0, 1, 1, 2, 3],
      effects: [
        ['Standing firm', 'Concrete bridges are very heavy. Only loose things on the deck blow around.'],
        ['Signs damaged', 'Road signs get bent or blown away. The bridge itself is fine.'],
        ['Poles down', 'Light poles bend and fall. The bridge still stands.'],
        ['Railings torn', 'Some railings are ripped off and thrown. Cars on the bridge can be blown off it.'],
        ['Stripped', 'Everything attached to the deck is torn away, but the concrete spans hold.'],
        ['Battered', 'The road surface is scoured off, but the heavy spans usually stay put. Very few bridges have taken a direct EF5 hit, so this is a best guess.'],
      ],
      parts: [
        P([[-205, 0], [-205, -121], [-182, -121], [-160, 0]], '#9a9a92'),
        P([[205, 0], [205, -121], [182, -121], [160, 0]], '#9a9a92'),
        R(-70, -55, 22, 110, '#a8a8a0'),
        R(70, -55, 22, 110, '#a8a8a0'),
        R(-70, -108, 44, 8, '#8f8f88'),
        R(70, -108, 44, 8, '#8f8f88'),
        R(0, -117, 400, 10, '#7d8590'),
        R(0, -126, 410, 10, '#6b6f75'),
        R(-180, -132, 40, 3, '#3c3f44', 5, { mass: 0.4 }),
        R(-140, -132, 40, 3, '#3c3f44', 5, { mass: 0.4 }),
        R(-100, -132, 40, 3, '#3c3f44', 5, { mass: 0.4 }),
        R(-60, -132, 40, 3, '#3c3f44', 5, { mass: 0.4 }),
        R(-20, -132, 40, 3, '#3c3f44', 5, { mass: 0.4 }),
        R(20, -132, 40, 3, '#3c3f44', 5, { mass: 0.4 }),
        R(60, -132, 40, 3, '#3c3f44', 5, { mass: 0.4 }),
        R(100, -132, 40, 3, '#3c3f44', 5, { mass: 0.4 }),
        R(140, -132, 40, 3, '#3c3f44', 5, { mass: 0.4 }),
        R(180, -132, 40, 3, '#3c3f44', 5, { mass: 0.4 }),
        R(-180, -137, 40, 12, '#c5c9ce', 3, { mass: 0.5, stroke: 'rgba(0,0,0,.25)' }),
        R(-140, -137, 40, 12, '#c5c9ce', 4, { mass: 0.5, stroke: 'rgba(0,0,0,.25)' }),
        R(-100, -137, 40, 12, '#c5c9ce', 3, { mass: 0.5, stroke: 'rgba(0,0,0,.25)' }),
        R(-60, -137, 40, 12, '#c5c9ce', 4, { mass: 0.5, stroke: 'rgba(0,0,0,.25)' }),
        R(-20, -137, 40, 12, '#c5c9ce', 4, { mass: 0.5, stroke: 'rgba(0,0,0,.25)' }),
        R(20, -137, 40, 12, '#c5c9ce', 3, { mass: 0.5, stroke: 'rgba(0,0,0,.25)' }),
        R(60, -137, 40, 12, '#c5c9ce', 4, { mass: 0.5, stroke: 'rgba(0,0,0,.25)' }),
        R(100, -137, 40, 12, '#c5c9ce', 3, { mass: 0.5, stroke: 'rgba(0,0,0,.25)' }),
        R(140, -137, 40, 12, '#c5c9ce', 4, { mass: 0.5, stroke: 'rgba(0,0,0,.25)' }),
        R(180, -137, 40, 12, '#c5c9ce', 4, { mass: 0.5, stroke: 'rgba(0,0,0,.25)' }),
        R(-140, -170, 4, 70, '#8a9099', 2, { id: 'pole1', mass: 0.8 }),
        R(-130, -205, 22, 3, '#8a9099', 99, { on: 'pole1' }),
        R(-120, -202, 8, 4, '#ffe7a0', 99, { on: 'pole1' }),
        R(0, -170, 4, 70, '#8a9099', 3, { id: 'pole2', mass: 0.8 }),
        R(10, -205, 22, 3, '#8a9099', 99, { on: 'pole2' }),
        R(20, -202, 8, 4, '#ffe7a0', 99, { on: 'pole2' }),
        R(140, -170, 4, 70, '#8a9099', 2, { id: 'pole3', mass: 0.8 }),
        R(150, -205, 22, 3, '#8a9099', 99, { on: 'pole3' }),
        R(160, -202, 8, 4, '#ffe7a0', 99, { on: 'pole3' }),
        R(-60, -152, 3, 36, '#8a9099', 2, { mass: 0.4 }),
        R(-60, -178, 54, 24, '#1f7a3c', 1, { mass: 0.6, stroke: '#ffffff' }),
      ],
    },
    {
